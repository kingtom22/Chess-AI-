...
public:
	...
	std::string get_loaded_font_file_name();
...
enum Color
{
    Black, White, Red, Green, Blue, Cyan, Yellow, Magenta, Focused_white, Focused_black
};
    ...
    color(Color c) 
    {
        ...
        case genv::Magenta:
            *this = color(255, 0, 255);
            break;
        case genv::Focused_white:
            *this = color(230, 230, 230);
            break;
        case genv::Focused_black:
            *this = color(50, 50, 50);
            break;
        }
    }
